...
class ProflieWidget extends StatefulWidget {
  const ProflieWidget({super.key});

  static String routeName = 'Proflie';
  static String routePath = '/proflie';

  @override
  State<ProflieWidget> createState() => _ProflieWidgetState();
}
